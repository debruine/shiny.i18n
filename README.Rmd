...
- **csv** - where each translation is in separate file `translation_<LANGUAGE-CODE>.csv`. Example of `translation_pl.csv` for Polish language you may find here: [`examples/data/translation_pl.csv`](https://github.com/Appsilon/shiny.i18n/blob/master/examples/data/translation_pl.csv).

- **json** - single json file `translation.json` with mandatory fields: `"languages"` with list of all language codes and `"translation"` with list of dictionaries assigning each translation to a language code. Example of such a json file for Polish language you may find here: [`examples/data/translation.json`](https://github.com/Appsilon/shiny.i18n/blob/master/examples/data/translation.json).
